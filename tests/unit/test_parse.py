...
_parse_tests: Sequence[_ParseTest] = [
    ...
    ("select named no spacing", ["[A]:t."], (0, 5)),
    ("select named space after colon", ["[A]: t."], (0, 6)),
    ("select named space before space after", ["[A] : t."], (0, 7)),
    ("select named space before colon", ["[A] :t."], (0, 6)),
    ...
    ("focus named no spacing", ["[A]:{"], (0, 4)),
    ("focus named trailing spacing", ["[A]:{ "], (0, 4)),
    ("focus named trailing newline", ["[A]:{", ""], (0, 4)),
    ("focus named space after colon", ["[A]: {"], (0, 5)),
    ("focus named newline after colon", ["[A]:", "{"], (1, 0)),
    ("focus named space before colon", ["[A] :{"], (0, 5)),
    ("focus named newline before colon", ["[A]", ":{"], (1, 1)),
    ("focus named space before space after", ["[A] : {"], (0, 6)),
    ("focus named newline before space after", ["[A]", ":", "{"], (2, 0)),
    ("focus named double space before double space after", ["[A]  :  {"], (0, 8)),
    (
        "focus named double newline before double space after",
        ["[A]", "", ":", "", "{"],
        (4, 0),
    ),
    ("focus named space after open bracket", ["[ A]:{"], (0, 5)),
    ("focus named space before close bracket", ["[A ]:{"], (0, 5)),
    ("focus named space inside brackets", ["[ A ]:{"], (0, 6)),
    ("focus named newline after open bracket", ["[", "A]:{"], (1, 3)),
    ("focus named newline before close bracket", ["[A", "]:{"], (1, 2)),
    ("focus named newline inside brackets", ["[", "A", "]:{"], (2, 2)),
    # elpi
